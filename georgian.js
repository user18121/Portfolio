  ...
  switch (section) {
    case 'bio':
      content = `
        <section id="bio">
          <h1>აღწერა</h1>
          <p>კეთილი იყოს თქვენი მობრძანება ჩემს პორტფოლიოში! მე ვარ განვითარებული პროგრამისტი, რომელსაც აქვს გამოცდილება ფრონტ-ენდის ტექნოლოგიებში. მიყვარს ინტერაქტიული ვებ-აპლიკაციების შექმნა და ახალი ტექნოლოგიების სწავლა.</p>
